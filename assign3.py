...
img=cv2.imread("Resources/tree.png")
img2=cv2.imread("Resources/lambo.png")
img3=cv2.imread("Resources/dog.png")
...
cv2.imwrite("temp/assign3_Original image.png",img)
...
cv2.rectangle(img, (100, 0), (50, 100), (0,127,127), 2)

cv2.imshow("Rectangle image",img)
cv2.imshow("Merged image",mergeimg)
cv2.waitKey(0)

cv2.imwrite("temp/assign3_Gray image.png",img_gray)
cv2.imwrite("temp/assign3_Blur image.png",imblur)
cv2.imwrite("temp/assign3_Canny image.png",imcanny)
cv2.imwrite("temp/assign3_Dilation image.png",imgd)
cv2.imwrite("temp/assign3_Eroded image.png",imge)
cv2.imwrite("temp/assign3_Crop image.png",imcrop)
cv2.imwrite("temp/assign3_Small image.png",imresizesm)
cv2.imwrite("temp/assign3_Fullscreen image.png",imresizefs)
cv2.imwrite("temp/assign3_Rectangle image.png",img)
cv2.imwrite("temp/assign3_Merged image.png",mergeimg)