...
cv2.imwrite("temp/assign1_Original image.png",img)
...
cv2.imwrite("temp/assign1_Gray image.png",img_gray)
cv2.imwrite("temp/assign1_Blur image.png",imblur)
cv2.imwrite("temp/assign1_Canny image.png",imcanny)
cv2.imwrite("temp/assign1_Dilation image.png",imgd)
cv2.imwrite("temp/assign1_Eroded image.png",imge)
cv2.imwrite("temp/assign1_Crop image.png",imcrop)
cv2.imwrite("temp/assign1_Small image.png",imresizesm)
cv2.imwrite("temp/assign1_Fullscreen image.png",imresizefs)
cv2.imwrite("temp/assign1_Rectangle image.png",img)
cv2.imwrite("temp/assign1_Merged image.png",mergeimg)